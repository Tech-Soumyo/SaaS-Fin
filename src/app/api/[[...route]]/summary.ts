...
// import { zValidator } from "@hono/zod-validator";
// import { clerkMiddleware, getAuth } from "@hono/clerk-auth";
// import { differenceInDays, parse, subDays, isValid, formatISO } from "date-fns";
// import { and, desc, eq, gte, lt, lte, sql, sum } from "drizzle-orm";
...
//     // Parse and validate dates with proper error handling
//     const defaultTo = new Date();
//     const defaultFrom = subDays(defaultTo, 30);
...
//     // Fetch both current and last period data in parallel
...
//     const currentPeriod = currentPeriodData[0] || {
//       income: 0,
//       expenses: 0,
//       remaining: 0,
//     };
...
//     // Refactored category aggregation logic
//     const topCategories = category.slice(0, 3);
//     const otherCategories = category.slice(3);
//     const otherSum = otherCategories.reduce(
//       (sum, current) => sum + current.value,
